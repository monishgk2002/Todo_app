...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getTodos: function getTodos() {
      ...
      this.$axios.post('/todos').then(function (res) {
    ...
    updateCheck: function updateCheck(id, status) {
      var _this3 = this;

      this.$axios.post("/todo/check/".concat(id), {
        status: status
      }).then(function (res) {
        if (res.data.success) {
          _this3.getTodos();
    ...
    deleteTodo: function deleteTodo(id) {
      ...
      this.$axios["delete"]("/todo/delete/".concat(id)).then(function (res) {
        if (res.data.success) {
          _this4.getTodos();
        }
      })["catch"](function (error) {
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "container page-content page-container",
              ...
              _c("div", { staticClass: "card px-3" }, [
                _c("div", { staticClass: "card-body" }, [
                  ...
                  _c("div", { staticClass: "list-wrapper" }, [
                    _c(
                      "ul",
                      { staticClass: "d-flex flex-column todo-list" },
...
/* harmony import */ var _views_Main__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/Main */ "./resources/js/views/Main.vue");
...
var app = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: '#app',
  components: {
    App: _views_Main__WEBPACK_IMPORTED_MODULE_2__["default"]
  }
});
...
__webpack_require__(/*! D:\laragon\www\todo-app\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\laragon\www\todo-app\resources\sass\app.scss */"./resources/sass/app.scss");
